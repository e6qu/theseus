...
| P11.14 | **`release: pin workflow action dependencies`** | **CURRENT PR.** Resolve every CI, release, and reproducibility workflow action to an immutable Git commit and make CI reject mutable action references. | External rebuild witnesses and broader source-dependency pinning. |
