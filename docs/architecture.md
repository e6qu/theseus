...
| Application coverage | `instrumentation/c`, `instrumentation/llvm` + `topology-runner` | GCC C blocks and LLVM C/C++/Rust edges with build-scoped, ASLR-independent identities, independent DSO runtimes, and retained symbols. |
