...
| Structured randomness | SDKs for Go, Java, C, C++, JavaScript, Python, Rust, .NET + JSONL | Bounded shell choices; Rust helper; Go module with the same vocabulary; language-neutral protocol | Java and C/C++ SDK helpers; immediate-use guidance feedback from generated values |
