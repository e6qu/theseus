...
grep -aF 'THES:SHELL:operation:read_seeded_data:PASS' campaign/services/api/serial.log
theseus compose replay campaign --output rerun
grep -aF 'THES:SHELL:operation:read_seeded_data:PASS' rerun/services/api/serial.log
