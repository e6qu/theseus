...
grep -aF 'THES:SHELL:operation:inspect_uid:PASS' campaign/services/api/serial.log
theseus compose replay campaign --output rerun
grep -aF 'THES:SHELL:operation:inspect_uid:PASS' rerun/services/api/serial.log
