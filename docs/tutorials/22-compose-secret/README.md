...
grep -aF 'THES:SHELL:operation:read_secret:PASS' campaign/services/api/serial.log
theseus compose replay campaign --output rerun
grep -aF 'THES:SHELL:operation:read_secret:PASS' rerun/services/api/serial.log
