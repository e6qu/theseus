...
| Faults | Network partitions, degradation, clogs, and restoration; node stop, kill, pause, and CPU throttling; clock and custom user-defined faults | Simulated network/storage plus Compose lifecycle, clock, and packet actions |
