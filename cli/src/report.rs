...
fn render_markdown(model: &ReportModel) -> String {
    ...
    {
        output.push_str(
            "\n## Command lifecycle\n\n| Operation | Test command | Phase | Process | Thread schedule | Structured choices |\n| --- | --- | --- | --- | --- | --- |\n",
        );
        for operation in &model.campaign_operations {
