...
fn campaign_timeline_labels(run: &CampaignRun) -> Vec<[String; 19]> {
    run.timeline
        .iter()
        .map(|boundary| {
...
fn render_markdown(model: &ReportModel) -> String {
    ...
    {
        output.push_str(
            "\n## Command lifecycle\n\n| Operation | Test command | Source | Phase | Process | Thread schedule | Structured choices |\n| --- | --- | --- | --- | --- | --- | --- |\n",
        );
        for operation in &model.campaign_operations {
